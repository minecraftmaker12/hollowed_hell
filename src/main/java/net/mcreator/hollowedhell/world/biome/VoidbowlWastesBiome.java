...
package net.mcreator.hollowedhell.world.biome;
...
public class VoidbowlWastesBiome {
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(HollowedhellMod.MODID, "voidbowl_wastes"),
				SURFACE_BUILDER);
	}
}
